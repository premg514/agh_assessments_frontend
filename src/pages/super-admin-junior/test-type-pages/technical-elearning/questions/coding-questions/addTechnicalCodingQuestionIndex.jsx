...
import AddTechnicalCodingQuestionFormIndex from "./addTechnicalCodingQuestionFromIndex";
  ...
  return (
    <>
      <Section>
        ...
        <TopTitleHeading>Add Coding Questions Form</TopTitleHeading>
        <AddTechnicalCodingQuestionFormIndex testId={testId} />
      </Section>
    </>
  );
};

export default AddCodingQuestionIndex;
